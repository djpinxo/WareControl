...
public class ModalAdapterContenedorContenedorHijosList extends RecyclerView.Adapter<ModalAdapterContenedorContenedorHijosList.ViewHolder> implements FragmentCallback<List<Contenedor>> {
    private List<Contenedor> contenedores;
    private Activity activity;
    private DialogFragment dialog;

    public ModalAdapterContenedorContenedorHijosList(List<Contenedor> contenedores, Activity activity, DialogFragment dialog) {
